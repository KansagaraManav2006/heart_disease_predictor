    ...
    return (
        <div className="max-w-6xl mx-auto animate-fade-in-up">
            ...
            <div className="text-center mb-16 mt-8">
                <h1 className="text-4xl md:text-6xl font-black mb-4 tracking-tight text-slate-800">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-16">
                <GlassCard className="glass-hover flex flex-col h-full transform transition-all hover:scale-105 border-t-4 border-t-blue-500">
                    <div className="bg-blue-500/20 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 text-blue-600">
                        <Activity size={32} />
                    </div>
                    <h2 className="text-2xl font-bold text-slate-800 mb-2">Diabetes Risk Scan</h2>
                ...
                <GlassCard className="glass-hover flex flex-col h-full transform transition-all hover:scale-105 border-t-4 border-t-red-500">
                    <div className="bg-red-500/20 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 text-red-600">
                        <Heart size={32} />
                    </div>
                    <h2 className="text-2xl font-bold text-slate-800 mb-2">Cardiac Risk Scan</h2>
                    <p className="text-slate-600 mb-8 flex-grow">
            ...
            <div className="mb-16">
                <h2 className="text-3xl font-bold text-center mb-10 text-slate-800">Why Use HealthPredict?</h2>
                <div className="grid md:grid-cols-3 gap-6">
                    <div className="glass p-6 text-center rounded-2xl">
                        ...
                        <p className="text-sm text-slate-600">Models trained on thousands of validated medical records.</p>
                    </div>
                    <div className="glass p-6 text-center rounded-2xl">
                        <div className="bg-primary/20 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-primary">
                            <Clock size={24} />
                        ...
                        <p className="text-sm text-slate-600">Get your health risk assessment in seconds.</p>
                    </div>
                    <div className="glass p-6 text-center rounded-2xl">
                        <div className="bg-primary/20 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-primary">
                            <FileText size={24} />
                        ...
                        <p className="text-sm text-slate-600">All predictions are processed without storing personal data.</p>
                    </div>
                </div>
            </div>

            {/* Important Notice */}
            <GlassCard className="bg-yellow-50 border border-yellow-200 text-center relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-yellow-400 to-orange-500"></div>
                <h3 className="text-xl font-bold text-yellow-700 mb-2">⚠️ Educational Purposes Only</h3>
