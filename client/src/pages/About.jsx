    ...
    return (
        <div className="max-w-4xl mx-auto animate-fade-in-up pb-12">
            <div className="text-center mb-12">
                <h1 className="text-4xl md:text-5xl font-black mb-4">About the Project</h1>
                <p className="text-lg text-slate-400">Healthcare Prediction System v2.0</p>
            </div>

            <GlassCard className="mb-12">
                <h2 className="text-2xl font-bold text-white mb-4 border-b border-slate-700 pb-2">Project Overview</h2>
