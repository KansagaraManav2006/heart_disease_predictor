    ...
    <div className={`mb-4 w-full text-left ${className}`}>
      ...
      <div className="relative">
        <select
          ...
          className={`w-full appearance-none bg-slate-900/90 text-slate-100 placeholder-slate-500 rounded-xl px-4 py-3 pr-10 text-sm min-h-[44px] border transition-all duration-200 focus:outline-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed ${
            hasError
