...
const Button = ({
  ...
  const variantClasses = {
    primary: 'bg-primary hover:bg-red-700 text-primary-foreground border border-red-800/40 shadow-md font-bold',
    ...
    danger: 'bg-destructive hover:bg-red-600 text-destructive-foreground shadow-md border border-red-500/40 font-bold',
    icon: 'p-2.5 bg-card hover:bg-muted text-foreground border border-border rounded-md w-11 h-11 shadow-sm',
  }[variant] || 'bg-primary hover:bg-red-700 text-primary-foreground font-bold';
